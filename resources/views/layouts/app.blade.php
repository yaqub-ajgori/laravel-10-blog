...
<head>
    ...
    <title>{{ $metaTitle ?: 'Yaqub Personal Blog' }}</title>
    <meta name="description" content="{{ $metaDescription}}">
    <meta name="author" content="Yaqub">
...
<body class="bg-gray-50 font-family-karla">
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center py-12">
            <a class="font-bold text-gray-800 uppercase text-5xl" href="/">
                {{ \App\Models\HeaderWidget::getSiteTitle('site-header') }}
            </a>
            <p class="text-lg text-gray-600">
                {{ \App\Models\HeaderWidget::getSiteDescription('site-header') }}
            </p>
        </div>
    </header>
            ...
            <div class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-between text-sm font-bold uppercase mt-0 px-6 py-2">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="hover:bg-blue-700 hover:text-white rounded py-2 px-4 mx-2 flex">
                    ...
                    @else
                    <a href="{{ route('login') }}" class="hover:bg-blue-700
                    hover:text-white rounded py-2 px-4 mx-2">Log In</a>
    ...
    <footer class="w-full border-t bg-white">
        <div class="w-full container mx-auto flex flex-col items-center">
            <div class="py-6">Yaqub.me &copy; {{ date('Y') }}</div>
    </footer>
